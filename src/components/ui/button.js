 ...
 * @property {boolean} [asChild] - Whether to render the button as a child slot.
 */
...
/**
 * A React button component with variants.
 * @param {ButtonVariantProps & React.ButtonHTMLAttributes<HTMLButtonElement>} props - The props for the button.
